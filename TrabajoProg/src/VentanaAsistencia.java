...
//		JLayeredPane: serie de ventanas que seran llamadas mediente botones
		...
		txtTextoCovid.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		txtTextoCovid.setBounds(35, 65, 363, 155);
		panelCovid.add(txtTextoCovid);

		JTextPane txtpnPrecaucionCovid = new JTextPane();
		txtpnPrecaucionCovid.setFont(new Font("Tahoma", Font.PLAIN, 12));
		...
		txtpnPrecaucionCovid.setBounds(659, 334, 490, 260);
